...
export type AttemptStatus = "running" | "awaiting_permission" | "awaiting_input" | "completed" | "blocked" | "failed" | "cancelled" | "skipped";
export type TaskState = "pending" | "ready" | AttemptStatus | "blocked_by_dependency";
export interface WhenClause { ref: string; equals?: Json; in?: Json[] }
