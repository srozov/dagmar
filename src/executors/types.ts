...
export interface InteractionRequest { kind: "permission" | "input"; method: "session/request_permission" | "elicitation/create"; request: Json; validate(response: Json): Json }
