...
export interface InteractionRequest { kind: "permission" | "input" | "turn" | "gate"; method: "session/request_permission" | "elicitation/create" | "turn/next" | "gate/answer"; request: Json; validate(response: Json): Json }
